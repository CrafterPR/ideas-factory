        ...
        <div class="homepage">
            ...
            <div class="zing-is-our-thing-section">
                <h2 class="zing-heading custom-container">fresh<img loading="lazy" class="plus-grid"
                                                                    :src="`${baseUrl}/img/plus-grid.png`" alt=""></h2>
                <div class="custom-container section-content">
                    <div class="row">
                        <div class="col-0 col-sm-0 col-md-2 col-lg-4 d-none d-md-block">
                            <img loading="lazy" class="black-arrow-down" :src="`${baseUrl}/img/arrow-solid-down-black.png`"  alt=""/>
                            <img loading="lazy" class="black-arrow-down" :src="`${baseUrl}/img/arrow-solid-down-black.png`"  alt=""/>
                            <img loading="lazy" class="black-arrow-down" :src="`${baseUrl}/img/arrow-solid-down-black.png`"  alt=""/>
                            <img loading="lazy" class="black-arrow-down" :src="`${baseUrl}/img/arrow-solid-down-black.png`"  alt=""/>
                        </div>
                    ...
                    <div class="swiper swiper-case-studies">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <router-link to="/">
                                    <img loading="lazy" :src="`${baseUrl}/img/case-studies/banners/main-banner.jpeg`"  alt=""/>
            ...
            <div class="showreel-section">
                <div class="section-content">
                    <div class="heading-container custom-container">
                        <h3>Showreel</h3>
                        <p>Watch our highlights from across the business, or <router-link to="/what-we-do">click here</router-link> to
                    ...
                    <div class="video-js-container">
                        <video
                            ...
                            :poster="`${baseUrl}/img/showreel.jpg`"
                        >
                            <p class="vjs-no-js">
            ...
            <div class="fresh-life-section">
                <div class="section-content">
                    <div class="heading-container custom-container">
                        ...
                        <img loading="lazy" class="arrow-grid" :src="`${baseUrl}/img/arrow-grid.png`" alt="">
                    </div>
                    <div class="custom-container">
                        <div class="social-links">
                            <a href="https://twitter.com/aidiasfactory" target="_blank">
                                <img loading="lazy" :src="`${baseUrl}/img/twitter.png`">
                            </a>
                            <a href="https://www.instagram.com/aidiasfactory" target="_blank">
                                <img loading="lazy" :src="`${baseUrl}/img/instagram.png`" alt="">
                            </a>
                            <a href="https://www.facebook.com/aidiasfactory" target="_blank">
                                <img loading="lazy" :src="`${baseUrl}/img/facebook.png`" alt="">
                            </a>
                            <a href="https://tiktok.com/aidiasfactory" target="_blank">
                                <img loading="lazy" :src="`${baseUrl}/img/vimeo.png`">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-content custom-container">
                    ...
                    <div class="award-images-container">
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award1.png`" alt="">
                        </div>
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award2.png`" alt="">
                        </div>
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award3.png`" alt="">
                        </div>
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award4.png`" alt="">
                        </div>
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award5.png`" alt="">
                        </div>
                        <div class="award-image-container">
                            <img loading="lazy" :src="`${baseUrl}/img/award-logos/award6.png`" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<script setup>
    ...
    onMounted(() => {
    const swiper = new Swiper(".swiper-client-logos", {
    ...
    el: ".swiper-scrollbar",
        ...
        new Swiper(".swiper-case-studies",{modules:[Pagination,Autoplay],direction:"horizontal",loop:!0,autoplay:{delay:5e3},pagination:{el:".swiper-pagination",clickable:!0}})
})
</script>
