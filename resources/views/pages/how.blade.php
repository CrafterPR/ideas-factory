    ...
    <how inline-template>
        <div class="how">
            <!--<video autoplay muted loop playsinline class="background-video">
                <source src="https://d130dmucovph5d.cloudfront.net/videos/work.mp4?v=156678" type="video/mp4">
            </video>-->
            ...
            <div class="zing-is-our-thing-section">
                <h2 class="how-heading custom-container" id="zing">Zing<img loading="lazy" src="img/roundals.png"></h2>
                <div class="section-content custom-container">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8">
                            <p>It's our uniquely fresh way of doing things</p>
                            <p>What we bring to the table</p>
                            <p>The secret spice we add to everything we do</p>
                            <p>Sprinkled through every project, piece of content, and across every client</p>
                            <p>Our passion and unmatch-ability encapsulated in word form</p>
                            <p><b>It’s how we make amazing things happen</b></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="joined-up-thinking-section">
                <div class="section-content custom-container">
                    <div class="row section-heading">
                        <div class="col-12">
                            <h3 class="joined-up green-text">Joined-up</h3>
                            <h3 class="thinking">thinking<img loading="lazy" src="img/donut.png"></h3>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="eighteen-years-section">
                <div class="section-content custom-container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="green-promise-section">
                <div class="section-content custom-container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="video-js-container">
                                <video
                                    ...
                                    src="https://d130dmucovph5d.cloudfront.net/videos/sustainability.mp4?v=629562"
                                >
                                    <p class="vjs-no-js">
