                    ...
                    <div class="collapse-container">
                        ...
                        <div class="collapse collapse-content-container creative-communication" id="collapseCreativeCommunication">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-2 image-content">
                                    <img loading="lazy" src="{{ asset('img/what-we-do/Comms_strategy_planning.jpg') }}">
                                </div>
                            </div>
                            <div class="row g-0">
                                <div class="col-12 col-lg-6 order-1 order-lg-2 text-content">
                    ...
                    <div class="collapse-container">
                        ...
                        <div class="collapse collapse-content-container integrated-marketing" id="collapseIntegratedMarketing">
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-2 image-content">
                                    <img loading="lazy" src="{{ asset('img/what-we-do/Consumer_campaign_strategy.jpg') }}">
                                </div>
                            </div>
                            <div class="row g-0">
                                <div class="col-12 col-lg-6 order-1 order-lg-2 text-content">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-1 image-content">
                                    <img loading="lazy" src="{{ asset('img/what-we-do/Brand_building.jpg') }}">
                                </div>
                            </div>
                            <div class="row g-0">
                                <div class="col-12 col-lg-6 order-1 order-lg-1 text-content">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-2 image-content">
                                    <img loading="lazy" src="{{ asset('img/what-we-do/Integrated_communications.jpg') }}">
                                </div>
                            </div>
                            <div class="row g-0">
                                <div class="col-12 col-lg-6 order-1 order-lg-2 text-content">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-1 image-content">
                                    <img loading="lazy" src="{{ asset('img/what-we-do/Trade_activation.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <p>Click above to find out more about each of our core service offerings,
                                <br>or head <a href="{{ route('what-we-done') }}">this way</a> to see our latest brand experiences.</p>
                        </div>
                    </div>
                </div>
            </div>
